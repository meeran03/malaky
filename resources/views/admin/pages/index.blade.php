    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-body box bg-cyan ">
                <h4 class="card-title text-white">كل الصفحات</h4>
            </div>
            <div class="comment-widgets">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <a href="{{route('admin.pages.edit' , [$one->id])}}" class="btn btn-cyan btn-sm"><i class="fas fa-edit"></i></a>
                                    <form action="{{route('admin.pages.update' , [$one->id])}}" method="POST" class="d-inline-block">
                                        @csrf
                                        {{method_field('PATCH')}}
                                    ...
                                    <form action="{{route('admin.pages.destroy' , [$one->id])}}" method="POST" class="d-inline-block">
                                        @csrf
                                        {{method_field('DELETE')}}
                ...
                <div class="border-top">
                    <div class="card-body text-left">
                        <a href="{{route('admin.pages.create')}}" class="btn btn-info">إضافة صفحة</a>
                    </div>
                </div>
            </div>
        </div>
